    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="text-pekerja">
                <h3 style="font-size: 25px; font-family: 'Open Sans', sans-serif;"><b>Pekerja Sekarang</b></h3>
            </div>
        </div>
    @endsection
        ...
        <div class="" style="margin-top: 0px">
            <div class="row">
                <div class="text-nama col-md-6" style="display:flex ;align-items: center">
                    <h3 style="font-size: 22px; margin-left: 20px; font-family: 'Nunito Sans', sans-serif; text-align:left"><b>{{$namaPekerja}}</b></h3>
                </div>
            ...
            <div class="isi row"style="margin-top: -5px">
                ...
                <div class="rp col-md-12" style="margin-top: -5px">
                    <div style="font-size: 16px; font-family: 'Nunito Sans', sans-serif;">Rp {{ number_format($gaji, 0, ',', '.') }}</div>
                </div>
